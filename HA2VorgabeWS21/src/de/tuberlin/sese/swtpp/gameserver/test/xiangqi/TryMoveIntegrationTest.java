...
public class TryMoveIntegrationTest {
	...
	public void HorseTest2() {
	    startGame("rheagaehr/9/1c5c1/s3s1s1s/9/9/S1S1S1S1S/1Cs4C1/9/RHEAGAEHR",true);
	    assertMove("b0-c2",true,true);
	    assertGameState("rheagaehr/9/1c5c1/s3s1s1s/9/9/S1S1S1S1S/1CH4C1/9/R1EAGAEHR",false,false,false);
	}
	@Test
	...
	public void ElephantTest2() {
	    startGame("rheagaeh1/9/1c5c1/s1s1s1s1s/9/9/S1S1S1S1S/1C2r2C1/9/RHEAGAEHR",true);
	    assertMove("c0-e2",true,true);
	    assertGameState("rheagaehr/9/1c5c1/s1s1s1s1s/9/9/S1S1S1S1S/1C2E2C1/9/RH1AGAEHR",false,false,false);
	}
	@Test
